...
def index(request):
    ...
    num_genres_contain_word = Genre.objects.filter(name__icontains='crime').count()
    ...
    context = {
            ...
            'num_genres_contain_word': num_genres_contain_word,
...
class AllBooksLoanedListView(PermissionRequiredMixin, generic.ListView):
    """Generic class-based view listing all of the books on loan"""
    model = BookInstance
...
class BookUpdate(UpdateView):
    model = Book
    fields = ['title', 'author', 'summary', 'isbn', 'imprint', 'genre', 'language',]
